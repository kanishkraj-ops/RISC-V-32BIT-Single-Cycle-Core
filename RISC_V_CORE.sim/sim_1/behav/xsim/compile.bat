...
REM
REM Generated by Vivado on Fri Jun 19 16:44:18 +0530 2026
...
echo "xvlog --incr --relax -prj riscv_tb_large_vlog.prj"
call xvlog  --incr --relax -prj riscv_tb_large_vlog.prj -log xvlog.log
